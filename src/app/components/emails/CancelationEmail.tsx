    ...
    <body style="font-family: Arial, sans-serif; background-color: #f4f4f4; margin: 0; padding: 20px;">
      <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; padding: 30px; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.05);">
        ...
        <div style="text-align: center; margin-bottom: 20px;">
          ...
          <h2 style="margin: 0 0 15px 0; color: #e91e63;">Tu turno fue cancelado</h2>
          <p style="margin-bottom: 15px; color: #555;">Lamentamos que no puedas asistir. Si querés reprogramar tu cita, podés hacerlo desde nuestra web.</p>
        </div>
  
        <div style="background-color: #fdf2f8; border: 1px solid #f8bbd0; padding: 15px; border-radius: 5px;">
          <h3 style="margin: 0 0 10px 0; color: #e91e63; font-size: 16px;">Detalles del turno cancelado:</h3>
          <p style="margin: 5px 0;"><strong style="color: #555;">Servicio:</strong> ${service}</p>
